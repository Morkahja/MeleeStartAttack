...
It starts normal melee auto-attack when you press a supported action-bar button against a living hostile target—even when the action cannot be used because it is on cooldown or you lack mana/rage.
...
- **Shaman:** Earth Shock, Flame Shock, Frost Shock, and Stormstrike.
